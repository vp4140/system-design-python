...
class Solution:
    ...
    def init(self, parking: list[list[list[int]]]):
        """
...
# Sample parking lot data (3 floors with rows and columns)
# 0 = No spot, 2 = Two-wheeler spot, 4 = Four-wheeler spot
parking_structure = [
    [
        [2, 2, 0],
        [4, 0, 4],
...
helper = Helper()
solution = Solution()
solution.init(parking_structure)

# Park a few vehicles
print("Parking vehicles...")
spot_id1 = solution.park(vehicle_type=2, vehicle_number="MH-01-AB-1234", ticket_id="T1", parking_strategy=0)  # Nearest parking
print(f"Vehicle parked at spot: {spot_id1}")

spot_id2 = solution.park(vehicle_type=4, vehicle_number="MH-02-CD-5678", ticket_id="T2", parking_strategy=1)  # Most free spots
print(f"Vehicle parked at spot: {spot_id2}")

# Search for a vehicle
print("\nSearching for vehicles...")
search_result1 = solution.search_vehicle(query="MH-01-AB-1234")
print(f"Vehicle MH-01-AB-1234 found at spot: {search_result1}")

search_result2 = solution.search_vehicle(query="T2")
print(f"Vehicle with ticket ID T2 found at spot: {search_result2}")

# Get free spot count
print("\nGetting free spots count...")
free_spots_floor_0_for_2w = solution.get_free_spots_count(floor=0, vehicle_type=2)
print(f"Free spots for 2-wheelers on floor 0: {free_spots_floor_0_for_2w}")

# Remove a vehicle
print("\nRemoving vehicles...")
removed1 = solution.remove_vehicle(spot_id=spot_id1)
print(f"Vehicle removed from spot {spot_id1}: {removed1}")

# Check free spots again
free_spots_floor_0_for_2w_after = solution.get_free_spots_count(floor=0, vehicle_type=2)
print(f"Free spots for 2-wheelers on floor 0 after removal: {free_spots_floor_0_for_2w_after}")
